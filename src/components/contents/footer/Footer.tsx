  ...
  return (
    <main className="bg-border pb-5 pt-[4em] font-br-regular">
      <div className="m-auto w-[80%] text-center">
        ...
        <div className="mt-[2em] space-x-5 font-br-light text-text">
        ...
        <div className="mt-[2em] flex items-center justify-center gap-5 font-br-light text-text">
        ...
        <hr className="border-1 mt-[2em] border-line" />
        <div className="mt-[2em] flex items-center justify-between rounded-full border border-line bg-purpleblack px-3 py-1.5 text-textp">
